export default function AboutMeAndCapabilities() {
  return (
    <div style={{ background: "#111", color: "#fff", minHeight: "100vh", fontFamily: "Inter, sans-serif" }}>
      <section style={{ display: "flex", padding: "4rem 2rem 2rem 2rem" }}>
        <div style={{ flex: 1 }}>
          <h1 style={{ fontSize: "2.5rem", fontWeight: "bold", letterSpacing: "2px" }}>ABOUT ME</h1>
        </div>
        <div style={{ flex: 2 }}>
      ...
      <section style={{ display: "flex", padding: "4rem 2rem 2rem 2rem" }}>
        <div style={{ flex: 1 }}>
          <h1 style={{ fontSize: "2.5rem", fontWeight: "bold", letterSpacing: "2px" }}>MY CAPABILITIES</h1>
        </div>
        <div style={{ flex: 2 }}>
          <p style={{ marginBottom: "2rem", color: "#ccc" }}>
            I’m always eager to grow and learn new technologies. So far, I’ve built a foundation in front-end and back-end development, and I’m continuing to expand my toolkit.
          </p>
          <div style={{ display: "flex", flexWrap: "wrap", gap: "1rem" }}>
            {["HTML", "CSS", "JAVASCRIPT", "JAVA", "REACT", "C#", "TAILWIND CSS", "PYTHON"].map(skill => (
